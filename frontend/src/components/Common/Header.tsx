      ...
      <div className="flex items-center justify-between h-16 px-4 lg:px-6">
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <div className="hidden md:block">
            <div className="relative">
              <input
                ...
                className="w-64 pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-brand-600 focus:ring-2 focus:ring-brand-100 transition-all"
                disabled
              />
          ...
          <div className="relative">
            ...
            >
              {/* Avatar */}
              <div className="w-8 h-8 bg-gradient-brand rounded-full flex items-center justify-center text-white font-semibold">
                {mockUser.name.charAt(0)}
              </div>
              {/* User Info (Hidden on mobile) */}
              <div className="hidden sm:block text-left">
                <p className="text-sm font-semibold text-gray-900">{mockUser.name}</p>
                <p className="text-xs text-gray-500">{getRoleLabel(mockUser.role)}</p>
              </div>
              {/* Dropdown Icon */}
            ...
            {showUserMenu && (
              <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-xl border border-gray-200 py-2">
                <div className="px-4 py-3 border-b border-gray-200">
                  ...
                  {mockUser.branch && (
                    <p className="text-xs text-brand-600 mt-1">{mockUser.branch}</p>
                  )}
                </div>
